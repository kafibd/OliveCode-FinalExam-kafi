...
<head>
	...
	<script type="text/javascript" src="/caohagan/js/jquery.min.js"></script>
...
<body>
	<div id="outer-cover">
		<div id="centering-container">
			<div id="first-one">
				<img src="/caohagan/images/idx-bkphoto1.png" width="988" height="680" />
<!-- 				<img src="../wp-content/themes/twentyfifteen/images/idx-bkphoto1.png" /> -->
			</div>
			<div id="second-one">
				<img src="/caohagan/images/idx-bkphoto2.png" width="836" height="689" />
			</div>
			<div id="third-one">
				<img src="/caohagan/images/idx-bkphoto3.png" width="719" height="542" />
			</div>			
		</div> 
		<div id="circle">
<!-- 			left: 50px; top: 300px; -->
			...
			<div class="all-circle" style="width: 170px; height: 170px; position: absolute;left: 350px; top: 560px;">
				<img src="/caohagan/photo/bln_photo2.jpg" style = "height: 170px; margin-left:-28.3333333333333px;">
			</div><!-- 2 -->
			<div class="all-circle" style="width: 220px; height: 220px; position: absolute; left: 600px; top: 750px;">
				<img src="/caohagan/photo/bln_photo3.jpg" style = "height: 220px; margin-left: -44.4943820224719px;">
			</div><!-- 3 -->
			<div class="all-circle" style="width: 190px; height: 190px; position: absolute; left: 360px; top: 850px;">
				<img src="/caohagan/photo/bln_photo4.jpg" style="width: 190px; margin-top: -38.57px;">
			</div><!-- 4 -->
			<div class="all-circle" style="width: 240px; height: 240px; position: absolute; left: 560px; top: 1050px;">
				<img src="/caohagan/photo/bln_photo5.jpg" style="height: 240px; margin-left: -60.1801801801802px;">
			</div><!-- 5 -->
			...
			<div class="all-circle" style="width: 190px; height: 190px; position: absolute; left: 990px; top: 2700px;">
				<img src="/caohagan/photo/bln_photo9.jpg" style="height: 190px; margin-left: -47.2155688622755px;">
			</div><!-- 9 -->
		...
		<div id="inner-cover">
			<header>
				<div id="site-header">
					<h1>
						<img src="/caohagan/images/idx-sitehead.png" width="789" height="479" />
					</h1>
				</div>
			</header>
<!-- 				yellow circle -->
			<div id="news01" class="news">
				<div class="article">
					<a href="javascript:btmOpen('fig05','004.html')" style="text-decoration: none">
						<h4 style="margin-left:50px;">お知らせ</h4>
							<dl>
								<dt>2014年6月25日</dt>
								<dd>島主コラムを更新しました。</dd>
							</dl>
						<img src="/caohagan/images/tmp_arrow-a.png">
					</a>
				</div>
			</div>
			<div id="news02" class="news">
				<div class="article">
					<a href="javascript:btmOpen('news','003.html')" style="text-decoration: none">
						<h4 style="margin-left:50px;">お知らせ</h4>
							<dl>
								<dt>2014年10月8日</dt>
			...
			<div id="idx-cont_fig01" style="height: 985px;">
				<article>
					<div class="idx-figCont">
						<div class="figImg">
							<img src="/caohagan/images/idx_ti_fig01.png" width="36" height="14" alt="fig01">
						</div>
						<div class="figTi">
							<h2>なにもなくて豊かな島<br>
							“カオハガン島”について</h2>
				...
				<div class="idx-bkTop">
					<img src="/caohagan/images/idx_cnt_fig01_bk_t.png" width="339" height="443">
				</div>
				<div class="idx-bkMid" style="height: 251px;"></div>
				<div class="idx-bkBtm" style="top: 658px;">
					<img src="/caohagan/images/idx_cnt_fig01_bk_b.png" width="339" height="325">
				</div>
			</div>
<!-- 			fig.02 -->
			<div id="idx-cont_fig02" style="height: 558px;">
				<article>
					<div class="idx-figCont">
						<div class="figImg">
							<img src="/caohagan/images/idx_ti_fig02.png" width="38" height="14" alt="fig01">
						</div>
						<div class="figTi">
							<h2>カオハガン島さんぽ</h2>
						</div>
				...
				<div class="idx-bkTop">
					<img src="/caohagan/images/idx_cnt_fig02_bk_t.png" width="513" height="246">
				</div>
				<div class="idx-bkMid" style="height: 46px;"></div>
				<div class="idx-bkBtm" style="top: 256px;">
					<img src="/caohagan/images/idx_cnt_fig02_bk_b.png" width="513" height="300">
				</div>
			</div>
			<!-- 			fig.03 -->
			<div id="idx-cont_fig03" style="height: 574px;">
				...
				<div class="idx-bkBtm" style="top: 392px;"><img src="/caohagan/images/idx_cnt_fig03_bk_b.png" width="396" height="180"></div>
			</div>
			<!-- 			fig.04 -->
			<div id="idx-cont_fig04" style="height: 463px;">
				...
				<div class="idx-bkBtm" style="top: 220px;"><img src="/caohagan/images/idx_cnt_fig04_bk_b.png" width="545" height="241"></div>
			</div>
			<!-- 			fig.05 -->
			<div id="idx-cont_fig05" style="height: 595px;">
				...
				<div class="idx-bkBtm" style="top: 306px;"><img src="/caohagan/images/idx_cnt_fig05_bk_b.png" width="395" height="280"></div>
			</div>
		</div>
		<footer >
			<div id="foot-container" style="top: 3612px; background-image:url('/caohagan/images/foot_bk.png')">
				<img src="/caohagan/images/foot_bird1.png" width="122" height="112" id="bird1">
				<img src="/caohagan/images/foot_bird2.png" width="118" height="104" id="bird2">
				<img src="/caohagan/images/foot_tree.png" width="162" height="190" id="tree">
				<img src="/caohagan/images/foot_logo.png" alt="Caohagan Island" width="344" height="75" id="logo">
				<img src="/caohagan/images/foot_copyright.png" alt="Copyright(C)2013 Caohagan Island All Rights Reserved." width="280" height="11" id="copyright">
			</div>
		</footer>
	</div>
